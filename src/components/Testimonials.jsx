...
const Testimonials = () => {
  return (
    <section
      name="Testimonials"
      className="flex flex-col items-center mb-20 text-gray-700"
    >
      <div className="w-fit lg:w-1/2">
        ...
        <div className="grid md:grid-cols-3 gap-6 text-center">
          ...
          <div>
            <div className="block rounded-lg shadow-lg bg-white">
              <div className="overflow-hidden rounded-t-lg h-28 bg-[#7a81a8]"></div>
              <div className="w-24 -mt-12 overflow-hidden border-2 border-white rounded-full mx-auto bg-white">
          ...
          <div>
            <div className="block rounded-lg shadow-lg bg-white">
              <div className="overflow-hidden rounded-t-lg h-28 bg-[#6d5b98]"></div>
              <div className="w-24 -mt-12 overflow-hidden border-2 border-white rounded-full mx-auto bg-white">
