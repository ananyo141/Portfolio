...
const SkillItem = ({ imgfile, proficiency }) => {
  return (
    <div className="group relative flex cursor-pointer">
      ...
      />
      <div className="absolute opacity-0 group-hover:opacity-80 group-hover:scale-110 transition duration-500 ease-in-out group-hover:bg-white h-24 w-24 rounded-full z-0">
